...
class WindowsPrinters(object):
	...
	def removePort(self,printerPortName):
		...
		"""
		cmd=r'cscript c:\Windows\System32\Printing_Admin_Scripts\ko-KR\prnport.vbs -d -r "'+printerPortName+'"'
		print cmd
	...
	def listPorts(self):
		...
		"""
		cmd=r'cscript c:\Windows\System32\Printing_Admin_Scripts\ko-KR\prnport.vbs -l'
		#print cmd
		stdout,_=subprocess.Popen(cmd,stdin=None,stderr=subprocess.STDOUT,stdout=subprocess.PIPE,shell=True).communicate()
		print stdout
	...
	def addPrinter(self,name,host='127.0.0.1',port=9101,printerPortName=None,makeDefault=False,comment=None):
		...
		cmd=r'cscript c:\Windows\System32\Printing_Admin_Scripts\ko-KR\prnport.vbs -md -a -o raw -r "'+printerPortName+'" -h '+host+' -n '+port
		#print cmd
		stdout,_=subprocess.Popen(cmd,stdin=None,stderr=subprocess.STDOUT,stdout=subprocess.PIPE,shell=True).communicate()
		print stdout
		# -- create the printer
